# code adapted from: https://github.com/AIPHES/emnlp19-moverscore/blob/master/moverscore_v2.py
...
model_name = '../models/BioLORD-2023-M-Dutch-InContext-v1'
...
def word_mover_score(refs, hyps, idf_dict_ref, idf_dict_hyp, stop_words=[], n_gram=1, remove_subwords = True, batch_size=256,device=device):
